...
| 小说生成 / 剧情提取 | `public/make.html` `public/make.js` | `POST /api/hub/novel-generate` `POST /api/hub/novel-extract` `POST /api/hub/novel-prompt-rewrite` | `src/hub/novel.js`；字幕≠生图词；DeepSeek 专改中英 Prompt；make 可 AI 改写/生图 |
